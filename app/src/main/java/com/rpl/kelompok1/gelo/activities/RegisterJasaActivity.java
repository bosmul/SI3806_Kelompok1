...
public class RegisterJasaActivity extends AppCompatActivity implements View.OnClickListener{
    private final AppCompatActivity activity = RegisterJasaActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_jasa);
    ...
    private void postDataToSQLite() {
        ...
        if (!databaseHelper.checkLaundry(textInputEditTextEmail.getText().toString().trim())) {
            ...
            laundry.setName(textInputEditTextName.getText().toString().trim());
            laundry.setEmail(textInputEditTextEmail.getText().toString().trim());
            laundry.setPassword(textInputEditTextPassword.getText().toString().trim());
            laundry.setAlamat(textInputEditTextAlamat.getText().toString().trim());
            laundry.setTelepon(textInputEditTextTelepon.getText().toString().trim());

            databaseHelper.addLaundry(laundry);
